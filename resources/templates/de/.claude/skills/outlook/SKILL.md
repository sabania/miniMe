...
Auf macOS uebernimmt der `macos-pim` Skill Mail, Kalender und Kontakte via osascript (Apple Mail, Calendar.app, Contacts.app). Dieser Skill ist nur fuer Windows.
