# search-emails.ps1 — Search emails in Inbox
# Usage: powershell -NoProfile -File scripts/search-emails.ps1 -Query "..." [-Count 20]
...
# DASL filter: search in subject and sender
